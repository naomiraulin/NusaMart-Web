...
<body class="bg-gray-50 text-gray-800 min-h-screen flex flex-col">
    ...
    {{-- KONTEN --}}
    {{-- Sebelumnya cuma "flex-1" tanpa batas lebar, sehingga konten melebar
         penuh mepet ke tepi layar. Disamakan dengan buyer-layout supaya
         konsisten: dibatasi max-w-7xl, di-tengahkan, dan diberi padding
         kiri-kanan. --}}
    ...
    <footer class="bg-white border-t border-gray-200 mt-auto">
        <div class="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-center gap-2 text-sm text-gray-400 text-center">
